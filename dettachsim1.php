					...
					<table>
						<tr align="center">
								<ul class="pagination" align="center">
									<?php 
										if($id > 1) { ?>
											<li><a href="?id=<?php $id-1;?>">Previous</a></li>
										<?php } 
										...
										for($i=1;$i<=$page;$i++) { 
											...
											if($i > $const && $startPoint <= $endPoint) {

												if ($firstFlag) {
													echo '<li><a href="?id=1">1</a></li>';
													echo '<li><a href="?id='.$const.'">...</a></li>';
													$firstFlag = false;
												}									 
													if ($i == $id) { 
														echo '<li><a href="javascript:void(0);" style="background:#366295; color:#fff;">'.$i.'</a></li>'; 
													}
													else {
									...
									?>
									<li><a href="?id=<?php echo $endPoint+5; ?>">...</a></li>
									<li><a href="?id=<?php echo $page; ?>"><?= $page; ?></a></li>
