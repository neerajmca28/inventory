...
if (isset($_SESSION['branch_id']) &&  !empty($_SESSION['branch_id'])) { 
  ...
  if (isset($_POST['submit1'])) {
      ...
      $deviceproblem = $_POST['deadremark']; // Device Problems

      if (!empty($_POST['deadremark'])){
          $closecasedate = date("Y-m-d H:i:s"); // Close Case Date
          $imei = $deviceImei;
          $sparecost = 0;
          ...
          if($repairclosecase){ header("Location:repairdevice.php"); }
      } 
      else {

           echo "<script>alert('Please Fill Dead Device Remarks ')</script>";
      }
    ...
    if (isset($_POST['submit2'])) {
      ...
      if (isset($_POST['contact'])) { $contactno = $_POST['contact']; }
      
      if (isset($_POST['scost'])) { $sparecost = 0; }
      else { $sparecost = 0;  }

      if ($_POST['optradio1'] == 1) { $internalrepair = 1; } 
      else { $internalrepair = 0; }
...
<body>
  <article>
    <div class="col-md-12 col-12"> 
      <form name="simfilter" method="post" action="" id="closecaseform">
              ...
              <table class='table borderless' id="someclass">
                ...
                <tr id="selected1">
                  ...
                  <td>
                    ...
                    <textarea class="form-control" rows="2" cols="20"  name="deadremark" id="comment" style="height: 46px; width: 419px; display: inline;"></textarea><span style="color: Red; display: inline;" >Cannot be blank</span>
                  </div>
                  </td>
                </tr>
                <tr id="selected2">
            ...
            <option value="Wrong authentication code">Modem communication error</option>
                ...
                <tr id="selected5">
                  ...
                  <td>
                    ...
                    <div class="form-group" >
                     <select  name="problems" class="selectpicker" data-show-subtext="true" data-live-search="true" id="problemsid" >
                      <option value="0">Please Select</option>
                ...
                <tr id="selected8">
                  ...
                  <td>
                    <div class="form-group">
                     <select  class="selectpicker" data-show-subtext="true" data-live-search="true" id="sel1">
                ...
                <tr id="selected13" style="display: none">
                  ...
                  <td>New Phone No</td> 
                  <td>  
                    <select name="phno" class="selectpicker" data-show-subtext="true" data-live-search="true" id="simno">
