...
<link rel="stylesheet" type="text/css" href="<?php echo __SITE_URL;?>/file/bootstrap.min.css">
 <link href="<?php echo __SITE_URL;?>/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<link rel="stylesheet" type="text/css" href="<?php echo __SITE_URL;?>/file/mycss2.css">
...
<!-- <script src="<?php echo __SITE_URL;?>/assets/bootstrap/bootstrap-datetimepicker.fr.js"></script>
 --><script src="<?php echo __SITE_URL;?>/dist/tablefilter/tablefilter.js"></script>
<script src="<?php echo __SITE_URL;?>/bootstrap/3.3.7/js/bootstrap.min.js"></script>
<script src="<?php echo __SITE_URL;?>/assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
