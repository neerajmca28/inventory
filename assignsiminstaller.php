				   	 ...
				   	 for($i=0;$i<$rowcount;$i++)
					 {
					   if(isset($_POST['rowVal'][$i]))
					   {
							...
							//echo count($selectSIMChallanDetails);die;
								...
								{
									$insertSIMChallanDetails=$masterObj->insertSIMChallanDetails($strChallanNo,$sim_id,$branchId,$Repair_id,$device_Removed_Date);
								}
								else
								{
				    ...
				    for($i=0;$i<$rowcount;$i++)
					{
					   ...
					   if(isset($_POST['rowVal'][$i]))
					   {
							...
							$selectSIMChallanDetails=$masterObj->selectSIMChallanDetails($sim_id);
								...
								if(count($selectSIMChallanDetails)<1)
								{
									$insertSIMChallanDetails=$masterObj->insertSIMChallanDetails($strChallanNo,$sim_id,$branchId,$repair_id,$branch_send_date);
								}
								else
								{
									if(count($selectSIMChallanDetails)>0)
