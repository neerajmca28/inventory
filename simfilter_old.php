    ...
    <div class="col-md-12 col-12"> 
      ...
      <!-- BEGIN BORDERED TABLE PORTLET-->
        <div class="portlet box yellow">
          ...
          <div class="caption"> <i class="fa fa-coffee"></i>Search By </div>
          </div>
            <div class="portlet-body control-box">
              ...
              <div class="content-box"  id="dateFilter" style="display:none">
                ...
                <div><div class="left-item"> <span>Start Date  :</span> </div><div class="right-item two-filter-inp"><input style="width:180px;" type="date" id="datestart" class="form-control"> </div></div>
                <div class="left-item"> <span>END Date  :</span> </div> <div class="right-item two-filter-inp"><input style="width:180px;" type="date" id="dateend" class="form-control"> </div>
                <div class="content-box">
                  <div class="left-item"></div>
           ...
           <img id="loading-image-speed" src="http://203.115.101.109/newtracking/reports/assets/img/Preloader_1.gif" style="position: absolute; z-index: 9999; left: 232px; display: none;"/>
      </form>
