        ...
        <table class="table table-bordered" id="filtertable">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td><?php echo date('d-m-Y H:i:s',strtotime($dispatchReplaceFFCdevice[$x]['ffc_date'])); ?></td>
              <td>
			  ...
			  <td><?php echo date('d-m-Y H:i:s',strtotime($dispatchReplaceFFCdevice[$x]['replaced_date'])); ?></td>    
            </tr>
            <?php } ?>
