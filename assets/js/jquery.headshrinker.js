    ...
    $.fn.headshrinker = function (options) {
        ...
        return this.each(function () {
            ...
            function headShrinker() {
				...
				timeout,
				headerHeight = jQuery('thead').outerHeight(),
				...
				// set up the cloned thead shrink and control show / hide
				headShrink
				...
				function shrinkMenu() {
					...
					if ( shrinkMenu === true || windowWidth <= menuSwitch ) {
						...
						// Expandable children
						jQuery('.headshrinker-menu tr tr' , headShrink).each(function() {
							
					        if(jQuery(this).children().length){
					        	jQuery(this).hide();
					            jQuery(this,'th:first').parent().append('<a class="headshrinker-expand" href="#">+</a>');                               
					        }
						...
						jQuery('.headshrinker-expand').on("click",function(e){
						    ...
						    if (jQuery(this).hasClass("headshrinker-clicked")) {
						    	jQuery(this).text('+');
						    	jQuery(this).prev('tr').slideUp(300, function(){});
						    } else {
						    	jQuery(this).text('-');
						    	jQuery(this).prev('tr').slideDown(300, function(){});
						    }   
