var TableAdvanced = function () {
    ...
    var initTable10 = function() {
        ...
        $('#sample_10 thead tr').each( function () {
            this.insertBefore( nCloneTh, this.childNodes[0] );
        } );
         
        $('#sample_10 tbody tr').each( function () {
        ...
        jQuery('#sample_10_wrapper .dataTables_filter input').addClass("form-control input-medium input-inline"); // modify table search input
        jQuery('#sample_10_wrapper .dataTables_length select').addClass("form-control input-small"); // modify table per page dropdown
         ...
         */
        $('#sample_10').on('click', ' tbody td .row-details', function () {
