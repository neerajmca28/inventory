...
$masterObj = new master();
 $login_name=$_SESSION['user_name_inv'];
  $strChallanNo=$_GET['challanNo'];
    ...
    // $dispatch_sendList=mysql_query("select * from branch_master where branch_name='".$dispatch_send."' ");  
    // $dispatch_send_id=mysql_fetch_array($dispatch_sendList);
    //      echo '<pre>';print_r($dispatch_send_id['id']); '</pre>'; 
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="122" align="left" style="padding-top: 8px; width: 150px;">
                                            <span id="lblInstallerName"><?php echo $dispatch_send; ?> </span>
                                        </td>
