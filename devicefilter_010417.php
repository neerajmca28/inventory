...
<body>
    ...
    <!-- BEGIN BORDERED TABLE PORTLET-->
      <div class="portlet box yellow">
        ...
        <div class="portlet-body">
          <form method="post">
            <div class="radio">
                <label><input type="radio" name="optradio" id="devItgcId" value="1" checked="checked">ITGC Id</label>
                <label><input type="radio" name="optradio" id="devId" value="2">ID</label>
                ...
                <div id="fiter1" class="devfilter" value="1">
                  ...
                  <thead>
                    ...
                    <tr>
                      <td><input type="text" id="itgc1" class="form-group" style="width:20%">X<input type="text" id="itgc2" class="form-group" style="width:20%"><div id="errmsg1" style="color:red"></div></td>
                    </tr>
                    <tr>
                ...
                <div id="fiter2" class="devfilter" value="2">  
                  ...
                  <thead>
                    ...
                    <tr>
                      <td><input type="text" id="keyid" class="form-group" style="width:20%"><div id="errmsg1" style="color:red"></div>
                    </tr>
                    <tr>
  ...
  <script>  
    ...
    //  alert(keyid);
      ...
      var date3 = $("#datepick3").val();
      var date4 = $("#datepick4").val();
