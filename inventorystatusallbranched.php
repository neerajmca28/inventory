  ...
  <div class="col-12"> 
    ...
    <div class="portlet box yellow">
      ...
      <div class="portlet-title" >
        <div class="caption"> <i class="fa fa"></i>Inventory Status
		</div>
      </div>
	  </div>
	    <div class="portlet box yellow">
	  	<div class="content-box">
					<div class="left-item"> <span> Branch Name:</span> </div><div class="right-item"><select class="form-control" name="ddlBranchName" id="ddlBranchName" onchange="inventoryStatus(this.value);">
...
var $inv = jQuery.noConflict();
     ...
     $inv( document ).ajaxStart(function() {
      $inv( "#loadingmessage" ).show();
    });
	    $inv( document ).ajaxStop(function() {
      $inv( "#loadingmessage" ).hide();
    }); 
function inventoryStatus(val)
{
	//alert(val);
	 //$inv( "#loadingmessage" ).show();
    $inv.ajax({
