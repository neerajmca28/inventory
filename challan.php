                ...
                <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" border="1">
						...
						<tr>
							...
							<tr>
							<td style="margin-left:200px">Challan No :</td>
							<td style="margin-left:200px"><?php echo $strChallanNo; ?></td>
					   </tr>
					   </table>
                    <table>
                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="250" valign="top">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td class="challan-text">
                                                        Date :
                                                    </td>
                                                    <td>
                                                        <span id="lblDate"><?php echo date('y-m-d'); ?></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="challan-text">
                                                    ...
                                                    <td>
                                                        <span id="lblTime"><?php echo date('H:i:s'); ?></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
{
 echo "There is Some Problem Inform your Software Team.";
}?>
