...
if (isset($_SESSION['branch_id']) && isset($_SESSION['user_name_inv']) && isset($_SESSION['userId_inv'])) {
  ...
  if (isset($_POST['deviceid']) && isset($_POST['dremovedate']) && isset($_POST['submit']) && isset($_POST['rowVal'])) {
echo  "1";die();
  ...
  <div class="col-12"> 
    ...
    <div class="portlet box yellow">
      ...
      <div class="portlet-body fix-table">
        <table class="table table-bordered table-hover" id="filtertable1">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php 
                  if($data[$i]['Is_Branch_Recevied'] == 1){
                      $isBranchRecd = "Delhi";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 2){
                    $isBranchRecd = "Mumbai";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 3){
                    $isBranchRecd = "Jaipur";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 4){
                    $isBranchRecd = "Sonepat";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 5){
                    $isBranchRecd = "Kanpur";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 6){
                    $isBranchRecd = "Ahmedabad";
                  }
                  if($$data[$i]['Is_Branch_Recevied'] == 7){
                    $isBranchRecd = "Kolkata";
                  }
                  echo $isBranchRecd; 
                ?>
              </td>
              ...
              <td><?php echo date('d-m-Y H:i:s',strtotime($data[$i]['StockRcDate'])); ?></td>
        ...
        <button type="submit" name="submit" class="btn btn-default table-btn-submit">RECEIVED</button>
      </div>
    </div>
