      ...
      <div class="portlet-body control-box">
        ...
        <div class="left-item"> <span>Device :</span> </div>
         ...
         <option>Select Model Type</option>
          ...
          <div class="right-item"><input  class="btn btn-primary btnaddsim"  name="Submit" value="Submit" id="submit"> <input  class="btn btn-default" type="reset" name="Submit" id="cancel" value="Cancel" onclick='cancelAll();'></div>
          </div>
		 </div>
      </div>
    </div>
