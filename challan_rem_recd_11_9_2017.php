...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
					...
					<img src="<?php echo __SITE_URL;?>/images/header1.png" width="400" height="250" />
                        ...
                        <tr>
                            <td align="center" style="padding-left: 20px; padding-right: 20px; padding-top: 10px;">
                               <span id="lblTime"><strong>Recevied Remove Devices Challan</strong></span>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-left: 20px; padding-right: 20px;">
	...
	<table cellspacing="0" rules="all" border="1" id="grdChallanDetail" style="width:98%;border-collapse:collapse;">
		<tr align="left">
			<th scope="col">SNo.</th><th scope="col">ITGC ID</th><th scope="col">IMEI</th><th scope="col">Antenna</th><th scope="col">Immobelizer</th><th scope="col">Connector</th><th scope="col">Assign Remarks</th><th scope="col">Installer Name</th>
		</tr><?php 
		for($j=0;$j<$count;$j++)
		{
			$y=$j+1;
		?>
			...
			<td align="center"><?php echo $GetChallanDetailByNo[$j]['device_installer_remarks'];?></td>
			<td align="center"><?php echo $GetChallanDetailByNo[$j]['InstallerName'];?></td>
			</tr>
		<?php }?>
	</table>
</div>
