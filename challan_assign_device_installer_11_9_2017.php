...
//$deviceListID=explode('-',$device_idList);
//echo '<pre>'; print_r($deviceListID); die;
// $installerList=db__select_staging("select inst_id from internalsoftware.installer where inst_name='".$to_installer_name."' ");
// echo "<pre>";
// print_r($device_idList); 
// "</pre>";
$GetInstallerChallanDetailByNo=$masterObj->GetInstallerChallanDetailByNo($strChallanNo,$device_idList);  
