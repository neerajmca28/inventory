...
if($count>0)
{
					if($GetSimInstallerChallanDetailByNo[0]['InstallerID']>0)
					{
						$selectInstallerTo=$masterObj->selectInstallerName($GetSimInstallerChallanDetailByNo[0]['InstallerID']);
						$Installer_name_to=$selectInstallerTo[0]['inst_name'];
						$flag=1;
					}
					
					if($GetSimInstallerChallanDetailByNo[0]['InstallerID']==-2)
					{
						$Installer_name_to="Dead";
						$flag=2;
					}
