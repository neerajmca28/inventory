...
if(isset($_GET['action']) && $_GET['action']=='monthly_sim_repair')
{
		...
		$SimMonthyRepair=select_Procedure("CALL SimMonthyRepair('".$branchID."','".$start_time."','".$end_time."')");
 ...
 <table class="table table-bordered table-hover" id="filtertable">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <?php $dt=date('d-m-Y',strtotime($SimMonthyRepair[$x]['rec_date'])); 
			   if($dt=='01-01-1970' )
				  {
					  $dt='';
				  }
				  ...
				  {
					   $dt=date('d-m-Y H:i:s',strtotime($SimMonthyRepair[$x]['rec_date']));
				  }
			  ?>
			  <td><?php echo $dt ?></td>
			  <?php $dt1=date('d-m-Y',strtotime($SimMonthyRepair[$x]['dispatch_date'])); 
			  if($dt1=='01-01-1970' )
				{
				  $dt1='';
				}
				...
				{
					 $dt1=date('d-m-Y H:i:s',strtotime($SimMonthyRepair[$x]['dispatch_date']));
				}
				  ?>
			  <td><?php echo $dt1 ?></td>
              <td><?php echo $SimMonthyRepair[$x]['device_imei'];?></td>
			  <td><?php echo $SimMonthyRepair[$x]['branch_name']; ?></td>
			  <td><?php echo $SimMonthyRepair[$x]['client_name'];?></td>
